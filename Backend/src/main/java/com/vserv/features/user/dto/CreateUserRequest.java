...
public class CreateUserRequest {
	...
	private Role.RoleName roleName; // ADMIN | ADVISOR | CUSTOMER
	
	@Size(max = 100, message = "Specialization must be at most 100 characters")
	private String specialization; // for ADVISOR
	
	private ServiceAdvisor.AvailabilityStatus availabilityStatus; // for ADVISOR
	
	@DecimalMin(value = "0.0", inclusive = true, message = "Overtime rate must be 0 or greater")
	private BigDecimal overtimeRate; // for ADVISOR
